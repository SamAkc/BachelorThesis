...
\keyword{titlepage.tex} -- This file creates the titlepage. In its initial form, several elements (e.\,g., displaying supervisor) are commented out. This is because the initial content of \file{titlepage.tex} sets up the title page of the PSIThesis Guide. Please check the content next to the TODO markers and remove the comments as instructed.
...
On Windows, you can use the TeXworks application for compilation. To obtain the final PDF, you have to compile \file{main.tex} with \code{lualatex}, then execute \code{biber}, and once more compile \file{main.tex} with \code{lualatex}.
...
Mext, open the file \file{misc/titlepage.tex}. Remove and add the comments as instructed by the TODO notes.
