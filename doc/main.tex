...
%	THESIS INFORMATION
%----------------------------------------------------------------------------------------
\newcommand{\thesistype}{Bachelor} % type of thesis

% Thesis title, print it elsewhere with \ttitle 
...
% date to be printed on the title
\def\tdate{\today}
\def\tdate{Juli 2020}

% Name, print it elsewhere with \authorname
\author{Samet Murat Akcabay}

% Supervisor's name, print it elsewhere with \supname
\supervisor{Prof. Dr. Dominik Herrmann}

% University's name and URL, print it elsewhere with \univname
\university{\href{https://www.uni-bamberg.de/en/}{Otto-Friedrich-Universität Bamberg}}

% Research groups name and URL, print it elsewhere with \groupname
\group{\href{https://www.uni-bamberg.de/informatik/psi/}{Lehrstuhl für Privatsphäre und Sicherheit in Informationssystemen}}

% Department's name, print it elsewhere with \deptname
\department{Fakultät für Wirtschaftsinformatik und Angewandte Informatik}

% Faculty's name and URL, print it elsewhere with \facname
...
\faculty{Applied Computer Science in the\\ \href{https://www.uni-bamberg.de/wiai/}{Faculty of Information Science and Applied Computer Science}}

% Adress, print it elsewhere with \addressname
\addresses{Brennerstraße 50\\96052 Bamberg}

% Subject are, print it elsewhere with \subjectname
\subject{subject not used}

% Keywords for thesis, print it elsewhere with \keywordnames
